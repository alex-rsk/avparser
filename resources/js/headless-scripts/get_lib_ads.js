...
{    
    ...
    var adObjects = [];
    var instaChannelSelector = '//*[@id="content"]/div/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div/div/div[3]/div[1]/div[1]',
        instaChannel = document.evaluate(instaChannelSelector, document, null, XPathResult.ANY_TYPE, null).iterateNext();
    var instaName = '';
    if (instaChannel)
    {
        instaName = instaChannel.innerText.replace('@', '');
    }
    document.querySelectorAll('._99s5').forEach((e) => {
        var adObj = [];
        ...
        {            
            ...
            if (el && el.publisherPlatform.indexOf('instagram') !== -1)
            {
                ...
                if (cards.length > 0)
                {
                    console.log(shot.displayFormat);
                    switch (shot.displayFormat)
                    {
                        ...
                        case 'carousel':
                            ...
                            var adObj = {
                                    ...
                                    endDate: el.endDate,
                                    instaName: shot.instagramActorName,
                                    instaUrl : instaName,
                                    pageName :  el.pageName,
                                    isActive: el.isActive,
                                    title: shot.title,
                                    instagramPic : shot.instagramProfilePicUrl,
                                    caption: text,
